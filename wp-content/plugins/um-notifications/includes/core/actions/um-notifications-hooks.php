...
add_action('um_activity_after_wall_post_bulled','um_notification_activity_bullpost', 90, 2 );
function um_notification_activity_bullpost( $post_id, $user_id ) {
    ...
    UM()->Notifications_API()->api()->store_notification( $author, 'new_post_bull', $vars );
}

add_action('um_activity_after_wall_post_beared','um_notification_activity_bearpost', 90, 2 );
function um_notification_activity_bearpost( $post_id, $user_id ) {
    ...
    UM()->Notifications_API()->api()->store_notification( $author, 'new_post_bear', $vars );
}
