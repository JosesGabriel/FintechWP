...
<div class="um-activity-commentl is-child" id="commentid-<?php echo $commentc->comment_ID; ?>">
	...
	<div class="um-activity-comment-info hidden-<?php echo $user_hidden; ?>">
		<div class="um-activity-comment-data">
			<span class="um-activity-comment-author-link"><a href="<?php echo um_user_profile_url(); ?>" class="um-link"><?php echo um_user('display_name'); ?></a></span> <span class="um-activity-comment-text">

				<?php 

				//echo comment_function();
				//echo "sample text";
				echo UM()->Activity_API()->api()->commentcontent( $commentc->comment_content ); 
		
			/*	 $content = UM()->Activity_API()->api()->commentcontent( $commentc->comment_content ); 
		...
		<div class="um-activity-comment-meta">
			...
			<?php if ( UM()->Activity_API()->api()->can_edit_comment( $commentc->comment_ID, get_current_user_id() ) ) { ?>
				<span class="um-activity-editc"><a href="#" style="font-size: 12px; color: #6583A8;">Edit<!--<i class="um-icon-edit"></i>--></a>
