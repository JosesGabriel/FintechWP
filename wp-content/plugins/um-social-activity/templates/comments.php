...
<script>
	jQuery(".um-activity-comment-textarea").on('blur',function(){
		jQuery(".um-activity-comment-box .um-activity-comment-textarea").addClass('auto-height');
	});
</script>