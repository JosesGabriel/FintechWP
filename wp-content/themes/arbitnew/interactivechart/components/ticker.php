<div class="arb_top_ticker">
    <div ng-controller="ticker" class="sd_border_btm arb_custom_ticker_wrapper">
        <ul id="droppouts" style="display: none;">
            <div class="ticker_enabler-modal">
                <span class="ticker_enabler-title">
                    <span class="ticker_enabler-text">Ticker Settings</span>
                    <div class="ticker_main-toggle">
                ...
                <div class="ticker_content-toggle">
                    <!-- <div class="data_checkboxes"> -->
                        <!-- <span class="data_ticker-toggle">Data</span> -->
                        <!-- <div class="data_ticker_main-toggle">
                            <span class="allstock_ticker-toggle">All Stocks</span>
                            <label class="switch">
                        ...
                        <div class="data_ticker_main-toggle">
                            <span class="sectorial_ticker-toggle">Sectorial Indices</span>
                            <label class="switch">
                                <input type="checkbox" checked>
                                <span class="slider round"></span>
                            </label>
                        ...
                        <div class="data_ticker_main-toggle">
                            <span class="watchlist_ticker-toggle">Watchlist</span>
                            <label class="switch">
                                <input type="checkbox" checked>
                                <span class="slider round"></span>
                            </label>
                    ...
                    <!-- </div> -->
                    <!-- <div class="speed_checkboxes">
                        <span class="speed_ticker-toggle">Speed</span>
                        <div class="speed_ticker_main-toggle">
                            <span class="cheetah_ticker-toggle">Cheetah</span>
                            <label class="switch">
                                <input type="checkbox" checked>
                                <span class="slider round"></span>
                            </label>
                        ...
                        <div class="speed_ticker_main-toggle">
                            <span class="rabbit_ticker-toggle">Rabbit</span>
                            <label class="switch">
                                <input type="checkbox" checked>
                                <span class="slider round"></span>
                            </label>
                        ...
                        <div class="speed_ticker_main-toggle">
                            <span class="turtle_ticker-toggle">Turtle</span>
                            <label class="switch">
                                <input type="checkbox" checked>
                                <span class="slider round"></span>
                            </label>
        ...
        <div class="hidden_this-marquee">
            <ul ng-if="enable" class="list-inline marqueethis arb_custom_ticker">
