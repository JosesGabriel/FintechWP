...
<div class="em-content-topic" style="text-align: left; font-size: 25px; font-weight: 500; margin-top: 0px; margin-bottom: 53px; line-height: 33px;">You recently changed the password associated with your account.</div>

<a class="login-prime-btn" style="border: 3px solid #123; padding: 10px 21px; color: #123; font-size: 18px; border-radius: 31px; text-decoration: none !important; font-weight: 500;" href="{user_account_link}">Go to your Account</a>

<div class="em-content-body" style="text-align: left; margin-top: 47px; font-size: 15px; line-height: 20px; font-weight: 500;">If you did not make this change and believe your account has been compromised, please<a href="mailto:{admin_email}"> contact us</a> ASAP.</div>
