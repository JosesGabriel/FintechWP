...
<div class="em-content-topic" style="text-align: left; font-size: 25px; font-weight: 500; margin-top: 0px; margin-bottom: 53px; line-height: 33px;">Hi {moderator_name}, {member_name} has requested to join {group_name}. <br /><br />You can view their profile here: {profile_link}. <br /><br />To approve/reject this request please click the following link: {groups_request_tab_url}</div>
