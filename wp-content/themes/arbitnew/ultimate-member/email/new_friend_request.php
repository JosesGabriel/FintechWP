...
<div class="em-content-topic" style="text-align: left; font-size: 25px; font-weight: 500; margin-top: 0px; margin-bottom: 53px; line-height: 33px;">Hi {receiver}, {friend} has just sent you a friend request on {site_name}.</div>

<div class="em-content-body" style="text-align: left; margin-top: 47px; font-size: 15px; line-height: 20px; font-weight: 500;">View their profile to accept/reject this friendship request: {friend_profile}</div>
