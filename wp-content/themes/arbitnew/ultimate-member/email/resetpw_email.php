...
<div class="em-content-topic" style="text-align: left; font-size: 25px; font-weight: 500; margin-top: 0px; margin-bottom: 53px; line-height: 33px;">We recieved a request to reset the password for your account. If you made this request, click the link below to change your password:</div>

<a class="login-prime-btn" style="border: 3px solid #142c46; padding: 10px 21px; color: #142c46; font-size: 18px; border-radius: 31px; text-decoration: none !important; font-weight: 500;" href="{login_url}">Reset your password</a>

<div class="em-content-body" style="text-align: left; margin-top: 47px; font-size: 15px; line-height: 20px; font-weight: 500;">If you didn't make this request, ignore this email or <a>report it to us.</a></div>
