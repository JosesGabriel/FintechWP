	   	...
	   	$.ajax({
		    ...
		    success: function(response) {
		    		...
		    		jQuery.each(response.data, function(i, val) {
	                    ...
	                    data_tradelogs += '<div style="width:65px">2019-02-23</div>';
	                    data_tradelogs += '<div style="width:55px" class="table-title-live">2</div>';
	                    data_tradelogs += '<div style="width:65px" class="table-title-live">₱24.87</div>';
	                    data_tradelogs += '<div style="width:95px" class="table-title-live">₱24.87</div>';
	                    data_tradelogs += '<div style="width:65px" class="table-title-live">₱10.00</div>';
	                    data_tradelogs += '<div style="width:88px" class="table-title-live">₱91.89</div>';
	                    data_tradelogs += '<div style="width:80px" class="table-title-live">₱22.55</div>';
	                    data_tradelogs += '<div style="width:65px" class="table-title-live">32.52%</div>';
	                    data_tradelogs += '<div style="width:65px; text-align:center">';
