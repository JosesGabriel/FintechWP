<style type="text/css">
	.container h2, .container h4, .container p {
	...
	.form-control.contact--textField::-moz-placeholder { /* Firefox 19+ */
		font-weight: 300;
		font-size: 12px;
	}
	.form-control.contact--textField:-ms-input-placeholder { /* IE 10+ */
		font-weight: 300;
		font-size: 12px;
	}
	.form-control.contact--textField:-moz-placeholder { /* Firefox 18- */
		font-weight: 300;
		font-size: 12px;
	}
...
/*# sourceMappingURL=0.956853032727c9c62076.css.map*/
</style>
