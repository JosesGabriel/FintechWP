  ...
  <div class="left-user-details-inner">
      <div class="side-header">
          <div class="left-image">
              <a href="https://arbitrage.ph/user/<?php echo $value['user_nicename']; ?>"><div class="user-image" style="background: url('<?php echo esc_url( get_avatar_url( $user->ID ) ); ?>') no-repeat center center;width: 29px;height: 29px;">&nbsp;</div>
              </a>
          </div>
      ...
      <div class="side-content">
          <div class="side-content-inner sidebariconssocial">
              <ul style="margin-top: 10px; font-family: Helvetica, Arial, sans-serif; font-weight: 600;">
                  <li class="one" style="margin-top: 8px;"><a href="https://arbitrage.ph/"><img src="<?php echo $cdnorlocal; ?>/svg/layout.svg">Social Wall</a></li>
