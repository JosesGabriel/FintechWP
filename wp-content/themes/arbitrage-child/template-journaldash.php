                                                                        ...
                                                                        <ul>
                                                                            <li class="headerpart">
                                                                            	<div style="width:100%;">
                                                                                    ...
                                                                                    <div style="width:17%" class="to-left-align">Debit</div>
                                                                                    <div style="width:17%" class="to-left-align">Credit</div>
                                                                                    <div style="width:17%" class="to-left-align">Balance</div>
																				...
																				foreach ($dledger as $key => $value) {
																					...
																					<li>
																						<div style="width:99%;">
																							...
																							<div style="width:17%" class="to-left-align">
		                                                                                    ...
		                                                                                    <div style="width:17%" class="to-left-align">₱<?php echo number_format($ledbalance, 2, '.', ',');  ?></div>
		                                                                                </div>
																					</li>
																			<?php
																					endif;
																			...
																			<li class="headerpart">
                                                                            	<div style="width:100%;">
                                                                                    ...
                                                                                    <div style="width:17%" class="to-left-align"><?php echo "₱ ".number_format($totdebit, 2, '.', ','); ?></div>
                                                                                    <div style="width:17%" class="to-left-align"><?php echo "₱ ".number_format($totcred, 2, '.', ','); ?></div>
                                                                                    <div style="width:17%" class="to-left-align">&nbsp;</div>
                                                                                    <!-- <div style="width:19%">Deposits</div>
                                                                                    <div style="width:19%">Ending Balance</div> -->
                                                                                </div>
                                                                            </li>
