																			...
																			<div class="entertrade" id="entertrade_mtrade">
																				...
																				<div class="entr_wrapper_top">
																						<div class="entr_col">
																							...
																							<input type="text" name="input_buy_product" id="input_buy_product" class="number" style="margin-left: -4px;" value="<?php echo number_format($buypower['aveprice'], 2, '.', ','); ?>" readonly>
