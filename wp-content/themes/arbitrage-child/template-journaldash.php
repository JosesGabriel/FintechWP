                                                                                    ...
                                                                                    <div class="dstatstrade">
                                                                                        <ul style="overflow: hidden;border-radius: 5px;">
                                                                                            ...
                                                                                            foreach ($finalwinning as $fwinkey => $fwinvalue) {
                                                                                                ...
                                                                                                $intowinchartbands .= ' "radius": "100%",';
                                                                                                $intowinchartbands .= ' "innerRadius": '.($fwinvalue['dprofit'] == 0 ? '20%' : ($fwinvalue['dprofit'] == 1 ? '60%' : ($fwinvalue['dprofit'] == 2 ? '80%' : ''))).'';
                                                                                            ...
                                                                                            foreach ($finalloss as $flosskey => $flossvalue) {
                                                                                                ...
                                                                                                $intolosschartbands .= '"innerRadius": '.($fwinvalue['dprofit'] == 0 ? '20%' : ($fwinvalue['dprofit'] == 1 ? '60%' : ($fwinvalue['dprofit'] == 2 ? '80%' : ''))).'';
