                                                                        ...
                                                                        <ul>
                                                                        	<li class="headerpart headerpart-tradelogs">
                                                                            	<div style="width:100%;">                                                                                	
                                                                                    ...
                                                                                    <div style="width:75px" class="table-title-live">Sell Value</div>
                                                                     	...
                                                                     	<input type="hidden" id="<?php echo 'dprofit' . $tnum; ?>" value="<?php echo $dprofit; ?>">
																			...
																			<li class="<?php echo $tlvalue['id']; ?> dloglist">
																				...
																				<div style="width:99%;">
																					...
																					<div style="width:75px" class="table-cell-live" id="<?php echo 'tsellvalue' . $tnum; ?>">₱<?php echo number_format($soldplace, 2, '.', ','); ?></div>
