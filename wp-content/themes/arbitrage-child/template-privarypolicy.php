...
<div class="container">
	<div class="sub-container" style="width: 100%; text-align: justify;">
		...
		<p class="p-padding">Arbitrage PH [https://arbitrage.ph/] (the "Site"). This page informs you of our policies regarding the collection, use, and disclosure of <strong>Personal Information</strong> we receive from users of the Site.</p>
		<p class="p-padding">We use your <strong>Personal Information</strong> only for providing and improving the Site. By using the Site, you agree to the collection and use of information in accordance with this policy.</p>

		<h4 class="sub-topics">Information Collection And Use</h4>

		<p class="p-padding">While using our Site, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you. Your identifiable information may be included but it is not limited to your name ("Personal Information").</p>
		...
		<p class="p-padding">Also, we may use third party services such as Google Analytics that collect, monitor and analyze this.</p>

		<h4 class="sub-topics">Communications</h4>

		<p class="p-padding">We may use your Personal Information to contact you with newsletters, marketing or promotional materials, and other information that we deemed helpful for your trading & investing activities.</p>

		<h4 class="sub-topics">Cookies</h4>

		<p class="p-padding">Cookies are files with small amount of data, which may include an anonymous unique identifier. Cookies are sent to your browser from a website and stored on your computer's hard drive. </p>
		...
		<p class="p-padding">This Privacy Policy is effective as of April 8, 2019, and will remain in effect except concerning any changes in its provisions in the future, which will be in effect immediately after being posted on this page. </p>
