...
<div class="arb_top_ticker">
    <div ng-controller="ticker" class="sd_border_btm arb_custom_ticker_wrapper">
           <ul class="list-inline marqueethis arb_custom_ticker">
                <?php /*?> temp-disabled <li ng-repeat="transaction in ticker" ng-class="::{'text-green': 0 < transaction.change, 'text-red': transaction.change < 0, 'text-grey': transaction.change == 0}">
                ...
                <li class="text-green">
                    ...
                    <a href="https://arbitrage.ph/chart/" target="_blank"><strong class="text-white" style="font-size:14px">BDO</strong></a><br>
                    <strong style="font-black: bold !important;"><?php echo rand(15,99); ?></strong>
                    &nbsp;(<strong style="font-weight: bold !important;"><?php echo rand(122,258); ?></strong>)
                </li>
                <li class="text-red">
                    <i class="fas fa-arrow-down" style="font-size: 14px;"></i>
                    <a href="https://arbitrage.ph/chart/" target="_blank"><strong class="text-white" style="font-size:14px">2GO</strong></a><br>
                    <strong style="font-black: bold !important;"><?php echo rand(15,99); ?></strong>
                    &nbsp;(<strong style="font-weight: bold !important;"><?php echo rand(122,258); ?></strong>)
                </li>
                <li class="text-grey">
                    <i class="fas normpadd" style="font-size: 14px;"></i>
                    <a href="https://arbitrage.ph/chart/" target="_blank"><strong class="text-white" style="font-size:14px">ICT</strong></a><br>
                    <strong style="font-black: bold !important;"><?php echo rand(15,99); ?></strong>
                    &nbsp;(<strong style="font-weight: bold !important;"><?php echo rand(122,258); ?></strong>)
                </li>
                <li class="text-green">
