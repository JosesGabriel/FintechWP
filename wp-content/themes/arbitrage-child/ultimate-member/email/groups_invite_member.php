...
<div class="em-content-topic" style="text-align: left; font-size: 25px; font-weight: 500; margin-top: 0px; margin-bottom: 53px; line-height: 33px;">Hi {group_invitation_guest_name}, {group_invitation_host_name} has invited you to join {group_name}. <br /><br />To confirm/reject this invitation please click the following link: {group_url}</div>
