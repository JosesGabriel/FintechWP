...
<div class="em-content-topic" style="text-align: left; font-size: 25px; font-weight: 500; margin-top: 0px; margin-bottom: 53px; line-height: 33px;">{display_name} has just created an account on {site_name}.</div>

<div style="padding: 0px 0 40px 0; color: #142c46; text-align: center;">To view their profile click here: {user_profile_link}</div>

<div style="background: #eee; color: #142c46; padding: 12px 15px; border-radius: 3px; font-weight: bold; font-size: 16px;">Here is the submitted registration form:<br /><br />{submitted_registration}</div>
