...
<div class="em-content-topic" style="text-align: left; font-size: 25px; font-weight: 500; margin-top: 0px; margin-bottom: 53px; line-height: 33px;">Thank you for signing up!<br />Your account is now active.</div>
<a class="login-prime-btn" style="border: 3px solid #142c46; padding: 10px 21px; color: #142c46; font-size: 18px; border-radius: 31px; text-decoration: none !important; font-weight: 500;" href="{login_url}">Login to our site</a>
<div class="em-content-body" style="text-align: left; margin-top: 47px; font-size: 15px; line-height: 20px; font-weight: 500;">If you have any problems, please contact us at {admin_email}</div>
