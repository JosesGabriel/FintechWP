						        	...
						        	<ul class="tabbutton">
										...
										<li class="totabs" style="color: white;" data-btname="bullish">
											<span style="margin-left: 0;">
												<img src="https://arbitrage.ph/assets/svg/Bullish-border.svg" style="width: 16px; padding: 5px; border-radius: 20px; border: 2px solid #24ae5f; padding: 8px 7px;">
											</span>
										...
										<li class="totabs" style="color: white;" data-btname="bearish">
											<span style="margin-left: 0;">
												<img src="https://arbitrage.ph/assets/svg/Bearish-border.svg" style="width: 12px; padding: 5px; border-radius: 20px; border: 2px solid #d04234; padding: 8px 7px;">
											</span>
